...
extern "C"  void EnemyBehavior_Update_m40697844 (EnemyBehavior_t122890614 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		Vector3_t2243707580  L_4 = Vector3_op_Multiply_m1351554733(NULL /*static, unused*/, L_3, (3.0f), /*hidden argument*/NULL);
		...
		NullCheck(L_2);
		Transform_Translate_m3316827744(L_2, L_6, /*hidden argument*/NULL);
	...
	{
		bool L_14 = __this->get_turnWasStarted_4();
		if (L_14)
		{
			goto IL_007f;
		}
...
IL_007f:
	{
		bool L_15 = __this->get_turning_3();
		if (!L_15)
		{
			goto IL_00ef;
		}
	}
	{
		...
		NullCheck(L_17);
		Vector3_t2243707580  L_18 = Transform_get_eulerAngles_m4066505159(L_17, /*hidden argument*/NULL);
		...
		NullCheck(L_17);
		Transform_set_eulerAngles_m2881310872(L_17, L_20, /*hidden argument*/NULL);
		...
		Vector3__ctor_m2638739322(&L_28, (0.0f), L_24, L_27, /*hidden argument*/NULL);
		NullCheck(L_21);
		Transform_set_eulerAngles_m2881310872(L_21, L_28, /*hidden argument*/NULL);
	}
...
IL_007f:
	{
		...
		float L_10 = Random_Range_m2884721203(NULL /*static, unused*/, (8.0f), (13.0f), /*hidden argument*/NULL);
